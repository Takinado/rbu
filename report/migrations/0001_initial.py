# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-08-17 07:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rbu_statuses', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='report.RbuStatus', verbose_name='Состояние блоков')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('carrier', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='report.Carrier', verbose_name='Машина')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='report.UnloadingType', verbose_name='тип'),
        ),
        migrations.AddField(
            model_name='status',
            name='unload',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='report.Unloading', verbose_name='Выгрузка'),
        ),
        migrations.AddField(
            model_name='status',
            name='vents1',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='report.InVents', verbose_name='Впускные вентили'),
        ),
        migrations.AddField(
            model_name='status',
            name='vents2',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='report.OutVents', verbose_name='Выпускные вентили'),
        ),
        migrations.AddField(
            model_name='loadbunker',
            name='status_curr',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='status_curr', to='report.Status', verbose_name='Статус ПОСЛЕ'),
        ),
        migrations.AddField(
            model_name='loadbunker',
            name='status_prev',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='status_prev', to='report.Status', verbose_name='Статус ДО'),
        ),
        migrations.AddField(
            model_name='carrier',
            name='type',
