...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('unload', '0002_auto_20170829_1309'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vents1', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='status.InVents', verbose_name='Впускные вентили')),
                ('vents2', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='status.OutVents', verbose_name='Выпускные вентили')),
            ],
            options={
