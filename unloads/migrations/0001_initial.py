    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('carrier', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='unloads.Carrier', verbose_name='Машина')),
            ],
            options={
                'ordering': ['date'],
        ...
        migrations.AddField(
            model_name='unload',
            name='type',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='unloads.UnloadType', verbose_name='тип'),
        ),
        migrations.AddField(
            model_name='carrier',
            name='type',
